export const MODEL = "mannix/llama3.1-8b-abliterated:q5_k_m";
...
// Ollama reasoning/tool metadata is deliberately never voiced.
...
export function ollamaPayload(messages, thinking = false) {
  return { model: MODEL, messages, stream: true, keep_alive: "10m",
